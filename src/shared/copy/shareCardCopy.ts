...
export const SHARE_CARD_COPY: ShareCardCopy[] = [
  ...
  // --- Sprint 2: Viral Copy (호구 탈출 테마) ---
  {
    id: 'c31',
    tone: '냉정',
    headline: '호구 인증서 발급',
    sub: '{{windowLabel}} 기준 호구 지수: -₩{{netLossWon}}. {{topCauseLabel}}에게 최다 손실.',
    footer: '인증서 발급을 거부할 권리가 있습니다.',
  },
  {
    id: 'c32',
    tone: '냉정',
    headline: '호구 탈출 D-Day',
    sub: '오늘부터 {{topPersonLabel}}에게 더 이상 무료 제공 없음. 손실 -₩{{netLossWon}} 여기서 끊는다.',
    footer: '탈출은 배신이 아니라 생존이다.',
  },
  {
    id: 'c33',
    tone: '냉정',
    headline: '인생 구조조정 1차 명단',
    sub: '{{topPersonLabel}} - 손실 -₩{{netLossWon}} / 원인: {{topCauseLabel}}. 경고 1회 발령.',
    footer: '2회 경고 시 관계 종료.',
  },
  {
    id: 'c34',
    tone: '유머',
    headline: '호구력 측정 완료 📊',
    sub: '{{windowLabel}} 호구력: {{hoursLost}}시간 + ₩{{netLossWon}}. 측정 결과: 최상급.',
    footer: '호구력 낮추기 프로젝트 시작.',
  },
  {
    id: 'c35',
    tone: '회복',
    headline: '호구에서 사람으로',
    sub: '{{topCauseLabel}}에 쓴 -₩{{netLossWon}}. 이제 나한테 쓴다. 전환 완료.',
    footer: '호구 졸업, 사람 입학.',
  },
  {
    id: 'c36',
    tone: '냉정',
    headline: '감정 영수증 발행',
    sub: '공급가액: -₩{{netLossWon}} / VAT(감정세): 추가 / 합계: 손해. {{topPersonLabel}} 청구.',
    footer: '영수증은 거짓말하지 않는다.',
  },
  {
    id: 'c37',
    tone: '유머',
    headline: '관계 감사 리포트 🧾',
    sub: '감사 결과: {{topCauseLabel}}에서 횡령 발견. 피해액 -₩{{netLossWon}}.',
    footer: '감사 완료. 조치 필요.',
  },
  {
    id: 'c38',
    tone: '냉정',
    headline: '손절 타임라인',
    sub: '{{windowLabel}}: {{topPersonLabel}} 관찰 기간 종료. 손실 -₩{{netLossWon}}. 결론: 손절.',
    footer: '미련은 사치다.',
  },
  {
    id: 'c39',
    tone: '회복',
    headline: '나 자신 주식회사 구조조정',
    sub: '비용 센터 {{topPersonLabel}} 정리. -₩{{netLossWon}} 절감 예상. 재투자: 나.',
    footer: '가장 좋은 투자는 나다.',
  },
  {
    id: 'c40',
    tone: '유머',
    headline: '{{windowLabel}} 관계 결산서',
    sub: '수익: 0원 / 비용: -₩{{netLossWon}} / 순이익: 마이너스. CEO(나) 분노 중.',
    footer: '다음 분기 개선 필수.',
  },
  {
    id: 'c41',
    tone: '냉정',
    headline: '호구 청산 보고서',
    sub: '청산 대상: {{topPersonLabel}}. 사유: {{topCauseLabel}}. 피해액: -₩{{netLossWon}}.',
    footer: '청산 완료 시 에너지 회복.',
  },
  {
    id: 'c42',
    tone: '회복',
    headline: '관계 다이어트 시작',
    sub: '{{topCauseLabel}} 컷. 예상 절감: -₩{{netLossWon}}. 목표: 건강한 관계만.',
    footer: '군살 빼면 가벼워진다.',
  },
  {
    id: 'c43',
    tone: '유머',
    headline: '멘탈 적자 경보 🚨',
    sub: '{{windowLabel}} 멘탈 결산: 대적자. 주요 원인: {{topPersonLabel}}. 긴급 조치 필요.',
    footer: '적자 탈출 프로젝트 가동.',
  },
  {
    id: 'c44',
    tone: '냉정',
    headline: '{{topPersonLabel}} 리스크 리포트',
    sub: '위험도: 높음. 손실: -₩{{netLossWon}}. 원인: {{topCauseLabel}}. 권고: 즉시 조치.',
    footer: '리스크는 관리하는 게 아니라 제거하는 것.',
  },
  {
    id: 'c45',
    tone: '유머',
    headline: '인간관계 포트폴리오 리밸런싱',
